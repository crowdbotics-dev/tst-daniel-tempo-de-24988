...
## Project Structure
    ...
    ├── tst_daniel_tempo_de_24988  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_tempo_de_24988`
...
2. Clone this repo and `cd tst_daniel_tempo_de_24988`
